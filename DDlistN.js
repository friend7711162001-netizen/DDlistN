...
const resourceData = [
    {
        ...
        icon: "📇",
        sheets: [
            { name: "集團名單", url: "https://docs.google.com/spreadsheets/d/109xIMXV25Ynq4Pg1YZkVdvSDstKDHPR61uy0oCQ2D9s/" },
            { name: "雅霖每月出勤", url: "https://docs.google.com/spreadsheets/d/1Fkc431V2FTikWxmPeoaSbWNbgjVZ7gUg4-IXl9UIZAY/" }
        ]
    },
    {
        target: "行程",
        ...
        sheets: [
            ...
            { name: "集團關懷基金", url: "https://docs.google.com/spreadsheets/d/1f1Av3naK5DHiN_jXVSZ_NKOIwTNd26bJ1rwBdJOeN2I/" },
            { name: "佣金計算", url: "https://docs.google.com/spreadsheets/d/1dW1nfZnDqgHtDwDBvCSNv-qaTSkNwKlqufHmt6-baGU/edit?gid=686785073#gid=686785073" }
        ]
    },
    {
        target: "班表",
        icon: "📅",
        sheets: [
            { name: "櫃檯班表", url: "https://docs.google.com/spreadsheets/d/130QCq1GylF5IsQzBpGG6h6Wm43ryus41EWagDuSSveA/" },
            { name: "房務班表", url: "https://docs.google.com/spreadsheets/d/1ryZQlsf1sTbGeghSYQohSItksV-rGCjR9zpXy_BntKg/" },
            { name: "集團班表", url: "https://docs.google.com/spreadsheets/d/1lJdKwwwWvGFo9Kcgo3PD7Q57CY2tMWJFSaxLacQu-Fo/" }
        ]
    }
];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const checkLogin = async () => {
        // 1. 先驗證帳號密碼
        if (usernameInput.value === "yalingdd" && passwordInput.value === "130724") {
        ...
        folder.sheets.forEach((sheet) => {
            ...
            sheetLinkEl.addEventListener("click", (e) => {
                ...
                if (sheet.url) {
                    ...
                    alert(`還沒放上「${sheet.name}」的網址喔！請到 DDlist.js 設定。`);
                }
            });
